...
public class AllFluids {
    ...
    public static final ForgeFlowingFluid.Properties METHAMPHETAMINE_PROPERTIES = new ForgeFlowingFluid.Properties(() -> LIQUID_METHAMPHETAMINE.get(), () -> METHAMPHETAMINE_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties BLUE_METHAMPHETAMINE_PROPERTIES = new ForgeFlowingFluid.Properties(() -> LIQUID_METHAMPHETAMINE.get(), () -> BLUE_METHAMPHETAMINE_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties METHYLAMINE_PROPERTIES  = new ForgeFlowingFluid.Properties(() -> METHYLAMINE.get(), () -> METHYLAMINE_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties METHANOL_PROPERTIES = new ForgeFlowingFluid.Properties(() -> METHANOL.get(), () -> METHANOL_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties HYDROGEN_PROPERTIES = new ForgeFlowingFluid.Properties(() -> HYDROGEN.get(), () -> HYDROGEN_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties OXYGEN_PROPERTIES = new ForgeFlowingFluid.Properties(() -> OXYGEN.get(), () -> OXYGEN_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties AMMONIA_PROPERTIES = new ForgeFlowingFluid.Properties(() -> AMMONIA.get(), () -> AMMONIA_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties PHENYLACETIC_ACID_PROPERTIES = new ForgeFlowingFluid.Properties(() -> PHENYLACETIC_ACID.get(), () -> PHENYLACETIC_ACID_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties ACETIC_ANHYDRIDE_PROPERTIES = new ForgeFlowingFluid.Properties(() -> ACETIC_ANHYDRIDE.get(), () -> ACETIC_ANHYDRIDE_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
    ...
    public static final ForgeFlowingFluid.Properties PHENYLACETONE_PROPERTIES = new ForgeFlowingFluid.Properties(() -> PHENYLACETONE.get(), () -> PHENYLACETONE_FLOWING.get(), FluidAttributes.Water.builder(WATER_STILL_RL, WATER_FLOWING_RL)
            .temperature(300).sound(SoundEvents.BOTTLE_FILL).overlay(WATER_OVERLAY_RL).color(0xbffcba03).density(2).luminosity(2).viscosity(5))
...
//todo: item models, fluid models, fluid block states, textures, fluid colors, plan acetic anhydride, recipes, world domination